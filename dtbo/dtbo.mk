APPEND_CERTS := $(COMMON_PATH)/dtbo/append_certs.py
...
$(BOARD_PREBUILT_DTBOIMAGE):
	...
	$(APPEND_CERTS) --alignment 16 --cert1 $(COMMON_PATH)/dtbo/cert1.der --cert2 $(COMMON_PATH)/dtbo/cert2.der --dtbo $(BOARD_PREBUILT_DTBOIMAGE)
